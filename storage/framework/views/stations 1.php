...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/stations 1.css')); ?>">
  <!-- ini css -->
...
<body>
    ...
    <header>
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light shadow fixed-top">
            <div class="container">
              ...
              <span class="menu">
                ...
                <li class="nav-item">
                  <a class="nav-link <?php echo e(($title === " kontak") ? 'active' : ''); ?>"
      ...
      <section id="gauge" style="background-color: rgb(27, 112, 223)">
        <div class="container">
          <div class="row">
            <div class="col">
              <h2 style="color :#fff"> Stations 1 </h2>
            </div>
          </div>
          <div class="row mb-4">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-body text-center">
                  <h6 class="card-title text-left">CO</h6>
                  <div id="co"></div>
                </div>
              </div>
            </div>
          ...
          <div class="row mb-4">
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-body text-center">
                  <h6 class="card-title text-left">Rainfall</h6>
                  <div id="rainfall"></div>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="card">
                <div class="card-body text-center">
                  <h6 class="card-title text-left">CH4</h6>
                  <div id="ch4"></div>
                </div>
              </div>
            </div>
          ...
          <div class="row mb-4">
            <div class="col-md-3">
              <div class="card">
                <div class="card-body text-center">
                  <h6 class="card-title text-left">C2H5OH</h6>
                  <div id="c2h5oh"></div>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="card">
                <div class="card-body text-center">
                  <h6 class="card-title text-left">H2</h6>
                  <div id="h2"></div>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="card">
                <div class="card-body text-center">
                  <h6 class="card-title text-left">NH3</h6>
                  <div id="nh3"></div>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="card">
                <div class="card-body text-center">
                  <h6 class="card-title text-left">NO2</h6>
                  <div id="no2"></div>
                </div>
              </div>
            </div>
  ...
  <div class="col-md-6">
    <canvas id="coChart" width="500" height="300"></canvas>
  </div>
  <div class="col-md-6">
    <canvas id="no2Chart" width="500" height="300"></canvas>
  </div>
  <div class="col-md-6">
  ...
  <div class="col-md-6">
    <canvas id="nh3Chart" width="500" height="300"></canvas>
  </div>
  <div class="col-md-6">
    <canvas id="c2h5ohChart" width="500" height="300"></canvas>
  </div>
  <!-- The following two <div> elements were not inside a <div class="row"> -->
  <div class="col-md-6">
    <canvas id="h2Chart" width="500" height="300"></canvas>
  </div>
  <div class="col-md-6">
    <canvas id="ch4Chart" width="500" height="300"></canvas>
  </div>
</div>
      ...
      <script src="<?php echo e(asset('js/stations 1.js')); ?>"></script>
...
<?php /**PATH D:\APP\climate\resources\views/petengoran.blade.php ENDPATH**/?>