...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/stations 2.css')); ?>">
  <!-- ini css -->
...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col">
        <h2 style="color: #fff"> Stations 2	</h2>
      </div>
    </div>
    <!-- First row -->
    <div class="row mb-4">
  ...
  <div class="row">
      ...
      <script src="<?php echo e(asset('js/stations 2.js')); ?>"></script>
...
</html><?php /**PATH D:\APP\climate\resources\views/stations 2.blade.php ENDPATH**/ ?>