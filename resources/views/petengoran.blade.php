...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css"
  ...
  rel="stylesheet" href="{{ asset('css/petengoran.css') }}"> <!-- ini css --> <title>Dashboard|Petengoran</title>
<!-- ini css -->
<style>
  .navbar-nav .nav-link {
    margin-right: 15px;
...
<section>
  ...
  <div class="chart-container">
    ...
    <!-- TDS SENSOR  -->
    <div class="chart">
      <canvas id="ChartSuhuDasar"></canvas>

    </div>
    <!-- DS18B20 -->
    <div class="chart">
      <canvas id="ChartDS18B20"></canvas>
    </div>
    <!-- Kadar Oksigen -->
    <div class="chart">
      <canvas id="ChartRainRouge"></canvas>
    </div>
    <!-- Salinitas -->
    <div class="chart">
      <canvas id="ChartAnemometer"></canvas>
    </div>
    <!-- Suhu Ruang -->
    <div class="chart">
      <canvas id="Chartwindwave"></canvas>
    </div>
    <!-- Salinitas -->
    <div class="chart">
    ...
    <!-- contraccless -->
    <div class="chart">
      <canvas id="Chartless"></canvas>
    </div>
    <!-- weightning -->
    <div class="chart">
      <canvas id="Chartweighting"></canvas>
    </div>
    <!-- ACS -->
    <div class="chart">
  ...
  <div class="container">
    ...
    <div class="footer-column text-center">
      ...
      <div class="row align-items-center">
        <div class="col-md-3 col-lg-8 text-md-left text-center mb-2 d-flex justify-content-md-end align-items-center">
