...
<head>
  ...
  <title>Dashboard|Microclimate Petengoran Stations 2	</title>
  <!-- ini css -->
  <style>
    .navbar-nav .nav-link {
      margin-right: 15px;
...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col">
        <h2 style="color: #fff">Dashboard Microclimate Petengoran Stations 2	</h2>
      </div>
    </div>
    <!-- First row -->
    <div class="row mb-4">
    ...
    <div class="row mb-4">
      ...
      <div class="col-md-3">
        <div class="card">
          <div class="card-body text-center">
            <h6 class="card-title text-left">Wind Direction</h6>
    ...
    <div class="row mb-4">
      ...
      <div class="col-md-3">
        <div class="card">
          <div class="card-body text-center">
            <h6 class="card-title text-left">Wind Direction Degrees</h6>
            <div id="wind direction degrees"></div>
          </div>
        </div>
      </div>
