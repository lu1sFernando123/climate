...
function getColorBasedOnValue(value, parameter) {
  if (parameter === "co") {
    ...
    if (value >= 0 && value <= 4) {
      ...
      return "green"; // Warna hijau untuk nilai antara 5 hingga 13
    } else if (value >= 14 && value <= 23) {
      return "yellow"; // Warna kuning untuk nilai antara 14 hingga 23
    } else if (value >= 24 && value <= 31) {
      return "red"; // Warna merah untuk nilai antara 24 hingga 31
    } else if (value >= 32) {
      return "black"; // Warna hitam untuk nilai di atas 32
    } else {
